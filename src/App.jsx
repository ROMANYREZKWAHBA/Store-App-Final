...
export default function App() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (cached) {
        setCustomRoles(JSON.parse(cached));
      } else {
        setCustomRoles(defaultCustomRoles);
      }
    } catch (e) {
      setCustomRoles(defaultCustomRoles);
    }
    customRolesHydrated.current = true;
  }, []);

  useEffect(() => {
    if (customRolesHydrated.current) {
